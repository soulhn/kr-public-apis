# work24_poa69_ncs20_dynamic_shard.py
...
#일학습병행_202401_202508_NCS정보통신_1,099건
# ■ 실행/출력
...
# HRDPOA69: 일학습병행 훈련과정
BASE_URL = "https://hrd.work24.go.kr/jsp/HRDP/HRDPO00/HRDPOA69/HRDPOA69_1.jsp"
BASE_PARAMS = {
    "authKey": AUTH_KEY,
    "returnType": "XML",
    "outType": "1",
    ...
    "sort": "ASC",
    "sortCol": "2",       # 1:기관명, 2:시작일
    "srchNcs1": "20",     # ✅ NCS 1차: 정보통신
    # crseTracseSe 미등록 = 전체 유형 (필요시 코드 지정 가능)
}
